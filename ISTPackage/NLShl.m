...
J[1][x_,t_]:={{G1[x,t][#]&,G1[x,t][#]&,L[x,t][#]&,L[x,t][#]&,DD[#]&,U[x,t][#]&,U[x,t][#]&,G3[x,t][#]&,G3[x,t][#]&,M[x,t][#]&,M[x,t][#]&,P[x,t][#]&,P[x,t][#]&},
...
Line[{0+s0[x,t],Exp[I*Pi/4]*\[Nu]*2+s0[x,t]}],Line[{Exp[I*Pi/4]*\[Nu]*2+s0[x,t],Exp[I*Pi/4]*\[Nu]*2+s0[x,t]+el}]},{bigN,bigN,bigN,bigN,bigN*2,bigN,bigN,bigN,bigN,bigN,bigN*2,bigN,bigN*2}};
Jsamp[1][x_,t_]:={{G1samp[x,t][#]&,G1samp[x,t][#]&,Lsamp[x,t][#]&,Lsamp[x,t][#]&,DDsamp[#]&,Usamp[x,t][#]&,Usamp[x,t][#]&,G3samp[x,t][#]&,G3samp[x,t][#]&,Msamp[x,t][#]&,Msamp[x,t][#]&,Psamp[x,t][#]&,Psamp[x,t][#]&},
{Line[{\[Nu]*Exp[I*Pi/4]+I*Abs[s0[x,t]]+I*el,\[Nu]*Exp[I*Pi/4]+I*Abs[s0[x,t]]}],
Line[{\[Nu]*Exp[I*Pi/4]+I*Abs[s0[x,t]],s0[x,t]}],
Line[{0+s0[x,t],Exp[-I*3*Pi/4]*\[Nu]+s0[x,t]}],Line[{Exp[-3I*Pi/4]*\[Nu]+s0[x,t],Exp[-I*3*Pi/4]*\[Nu]+s0[x,t]-el}],
Line[{0+s0[x,t],-el+s0[x,t]}],
