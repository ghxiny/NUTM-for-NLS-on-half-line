...
Setexpconst[exp_]:=Module[{},expconst=exp;Print["Expconst is ",expconst]];(*having this large solves the bug, looks like invertion is the reason*)
expconst=100000;
bigN=20;
smallN=10;
el=30;
...
xcoord[x_,t_]:=(Sqrt[(x/4/t)^2+4*\[Nu]]-x/4/t)/2;
ycoord[x_,t_]:=\[Nu]/xcoord[x,t];
J[1][x_,t_]:={{G1[x,t][#]&,G1[x,t][#]&,G3[x,t][#]&,G3[x,t][#]&,M[x,t][#]&,M[x,t][#]&,P[x,t][#]&,P[x,t][#]&},
{Line[{xcoord[x,t]+I*ycoord[x,t]+I*el,xcoord[x,t]+I*ycoord[x,t]}],
Line[{xcoord[x,t]+I*ycoord[x,t],s0[x,t]}],
(*G3*)
Line[{xcoord[x,t]-I*ycoord[x,t]-I*el,xcoord[x,t]-I*ycoord[x,t]}],
Line[{xcoord[x,t]-I*ycoord[x,t],s0[x,t]}],
Line[{0+s0[x,t],Exp[-I*Pi/4]*\[Nu]*Sqrt[2]+s0[x,t]}],Line[{Exp[-I*Pi/4]*\[Nu]*Sqrt[2]+s0[x,t],Exp[-I*Pi/4]*\[Nu]*Sqrt[2]+s0[x,t]+el}],
Line[{0+s0[x,t],Exp[I*Pi/4]*\[Nu]*Sqrt[2]+s0[x,t]}],Line[{Exp[I*Pi/4]*\[Nu]*Sqrt[2]+s0[x,t],Exp[I*Pi/4]*\[Nu]*Sqrt[2]+s0[x,t]+el}]},{bigN,bigN,bigN,bigN,bigN,bigN*5,bigN,bigN*5}};
...
(*minimal contour*)
s0[x_,t_]:=N[If[Abs[t]<0.0001,-el,-Min[x/4/t,el]]];
xcoord[x_,t_]:=(Sqrt[(x/4/t)^2+4*(\[Nu]/6)]-x/4/t)/2;
ycoord[x_,t_]:=(\[Nu]/2)/xcoord[x,t];
J[1][x_,t_]:={{G1[x,t][#]&,G3[x,t][#]&,M[x,t][#]&,P[x,t][#]&},
{Line[{xcoord[x,t]+I*\[Nu]+I*el,xcoord[x,t]+I*\[Nu]}],
Line[{xcoord[x,t]-I*\[Nu]-I*el,xcoord[x,t]-I*\[Nu]}],
Line[{xcoord[x,t]-I*\[Nu],xcoord[x,t]-I*\[Nu]+el}],
Line[{xcoord[x,t]+I*\[Nu],xcoord[x,t]+I*\[Nu]+el}]},{bigN,bigN,bigN,bigN}};
Jsamp[1][x_,t_]:={{G1samp[x,t][#]&,G3samp[x,t][#]&,Msamp[x,t][#]&,Psamp[x,t][#]&},
{Line[{xcoord[x,t]+I*\[Nu]+I*el,xcoord[x,t]+I*\[Nu]}],
Line[{xcoord[x,t]-I*\[Nu]-I*el,xcoord[x,t]-I*\[Nu]}],
Line[{xcoord[x,t]-I*\[Nu],xcoord[x,t]-I*\[Nu]+el}],
Line[{xcoord[x,t]+I*\[Nu],xcoord[x,t]+I*\[Nu]+el}]},{bigN,bigN,bigN,bigN}};
...
(* ::Input::Initialization:: *)
J[2][x_,t_]:={{Inverse[G1s[x,t][#]]&,Inverse[G1s[x,t][#]]&,Inverse[G3s[x,t][#]]&,Inverse[G3s[x,t][#]]&,Ms[x,t][#]&,Ms[x,t][#]&,Ps[x,t][#]&,Ps[x,t][#]&},
{Line[{Sqrt[t/2]*\[Nu]*Exp[I*Pi/4+0.I]+I*el,Sqrt[t/2]*\[Nu]*Exp[I*Pi/4+0.I]}],
Line[{Sqrt[t/2]*\[Nu]*Exp[I*Pi/4+0.I],0}],
(*G3*)
Line[{Sqrt[t/2]*\[Nu]*Exp[-I*Pi/4-0.I]-I*el,Sqrt[t/2]*\[Nu]*Exp[-I*Pi/4-0.I]}],
Line[{Sqrt[t/2]*\[Nu]*Exp[-I*Pi/4-0.I],0}],
Line[{0,Sqrt[t/2]*Exp[-I*Pi/4]*\[Nu]*2}],Line[{Sqrt[t/2]*Exp[-I*Pi/4]*\[Nu]*2,Sqrt[t/2]*Exp[-I*Pi/4]*\[Nu]*2+el}],
Line[{0,Sqrt[t/2]*Exp[I*Pi/4]*\[Nu]*2}],Line[{Sqrt[t/2]*Exp[I*Pi/4]*\[Nu]*2,Sqrt[t/2]*Exp[I*Pi/4]*\[Nu]*2+el}]},{bigN,bigN,bigN,bigN,bigN,bigN*2,bigN,bigN*2}};
Jsamp[2][x_,t_]:={{G1samp[x,t][#]&,G1samp[x,t][#]&,G3samp[x,t][#]&,G3samp[x,t][#]&,Msamp[x,t][#]&,Msamp[x,t][#]&,Psamp[x,t][#]&,Psamp[x,t][#]&},
{Line[{Sqrt[t/2]*\[Nu]*Exp[I*Pi/4+0.1I]+I*el,Sqrt[t/2]*\[Nu]*Exp[I*Pi/4+0.1I]}],
Line[{Sqrt[t/2]*\[Nu]*Exp[I*Pi/4+0.1I],0}],
(*G3*)
Line[{Sqrt[t/2]*\[Nu]*Exp[-I*Pi/4-0.1I]-I*el,Sqrt[t/2]*\[Nu]*Exp[-I*Pi/4-0.1I]}],
Line[{Sqrt[t/2]*\[Nu]*Exp[-I*Pi/4-0.1I],0}],
Line[{0,Sqrt[t/2]*Exp[-I*Pi/4]*\[Nu]*2}],Line[{Sqrt[t/2]*Exp[-I*Pi/4]*\[Nu]*2,Sqrt[t/2]*Exp[-I*Pi/4]*\[Nu]*2+el}],
