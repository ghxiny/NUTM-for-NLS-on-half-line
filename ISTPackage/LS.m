...
FT[Q,Qb,id,IIm,IImb]] (*This is the output of the module*);
...
ans0[[-1]]-ans1[[1]]    (*use chebyshev? and interpolation to find values of fourier transform*)
];
...
(*Print[{a+k0,a+Lt}//N];*)
z = DomainIntegrate[{fun1,fun2,fun3}];  (*this sums all three funs*)
(*Print[z];
Print[DomainIntegrate[fun3]];*)
];
z
];
